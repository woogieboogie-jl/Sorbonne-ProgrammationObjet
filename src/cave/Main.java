...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			c1.ajouter(new Petrus(Vin.getMinimumVolume() , 700, 2008));
			...
			pp.setAnnee(1865);
			c1.ajouter(pp);
			c2.ajouter(new Petrus(Vin.getMinimumVolume() + 100, 15000, 1685));
			c2.ajouter(new Petrus(Vin.getMinimumVolume() + 100, 20000, 2085));
			c2.ajouter(new Petrus(Vin.getMinimumVolume() + 100, 11300, 1785));
			c2.ajouter(new PerrierJouet(Vin.getMinimumVolume() + 100, 15000, 1994));
			c2.ajouter(new PerrierJouet(Vin.getMinimumVolume() + 50, 3000, 1984));
			c2.ajouter(new DomPerignon(100, 10000, 1804));
			c2.ajouter(new DomPerignon(Vin.getMinimumVolume(), 7500, 1784));
			c2.ajouter(new ChateauDEsclans(Vin.getMinimumVolume(), 5000, 1834));
			c1.ajouter(new ChateauDEsclans(Vin.getMinimumVolume() , 3000, 1954));
			c1.ajouter(new ChateauDEsclans(Vin.getMinimumVolume() , 3500, 1984));
			c1.ajouter(new ChateauDEsclans(Vin.getMinimumVolume() , 700, 2004));
			c2.ajouter(new ChateauDEsclans(Vin.getMinimumVolume() + 50, 320, 2004));	
